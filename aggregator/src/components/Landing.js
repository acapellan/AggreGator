      ...
      <div className="container-fluid" style={{backgroundImage:`url(${treeBackground})`, backgroundSize:"cover", backgroundRepeat:"repeat"}}>
        <div className="px-4 py-5 text-center">
          <img
            ...
            height="192"
          />
          <h1 className="display-5 fw-bold" style={{color: 'white'}}>Welcome to AggreGator!</h1>
          ...
          <div className="container">
            <div className="row my-2">
              <div className="col">
                  ...
                  <a type="button" className="btn btn-primary btn-lg px-4 text-nowrap mx-2" href="#" style={{width: 165}}>Sign Up</a>
              </div>
            </div>
            <div className="row my-2">
              <div className="col">
